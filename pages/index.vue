<template>
  <div class="grid-container">
    ...
    <div class="left-area">
      <div class="content">
        <!-- <h1>Hi, our team is ready to help you.</h1> -->
        <div
          v-for="image in images"
          :class="`title-slide text-` + image.id"
          :key="image.id"
        >
          <h1>{{ image.title }}</h1>
          <p>
    ...
    <div class="left-area-2">
      <div class="content-2">
        ...
        <div
          v-for="image in images"
          :class="`title-slide safari text-` + image.id"
          :key="image.id"
        >
          <h1>{{ image.title }}</h1>
          <p>
  ...
  data() {
    return {
      images: [
        ...
        {
          id: "2",
          title: "Cool right? let's build for you.",
